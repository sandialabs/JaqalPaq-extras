...
#***************************************************************************************************
from pygsti.tools.basisconstructors import _basisConstructorDict, _check_dim, MatrixBasisConstructor, mut
...
if 'col' not in _basisConstructorDict:
    _basisConstructorDict['col'] = MatrixBasisConstructor('Column-stacked matrix-unit basis', col_matrices,
                                                          col_labels, False)
