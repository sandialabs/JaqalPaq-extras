...
* The :mod:`jaqalpaq.transpilers.cirq`, :mod:`jaqalpaq.transpilers.projectq`, :mod:`jaqalpaq.transpilers.qiskit`, :mod:`jaqalpaq.transpilers.quil`, and :mod:`jaqalpaq.transpilers.tket` packages allow conversion between :mod:`jaqalpaq.core` objects and their counterparts in other popular quantum software development frameworks.
